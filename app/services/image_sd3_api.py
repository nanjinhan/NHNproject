...
def generate_image_from_sd3(
    ...
    aspect_ratio: str = "4:5",          # 기본은 세로형(768x1024 느낌)
    ...
    - aspect_ratio: "1:1", "3:4", "4:5", "9:16" 등 비율 문자열
    - seed: 없으면 내부에서 랜덤 생성
    ...
    print(f"[SD3.5 API] request: aspect_ratio={aspect_ratio}, seed={seed}")
    ...
    filename = f"outputs/sd35_{ts}_seed{seed}.{output_format}"
    img.save(filename)
